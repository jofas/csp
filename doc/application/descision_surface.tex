...
\begin{figure*}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{align*}
      \tau_{|X|} = 2&, N = 2, \\
      predicted &= \input{application/data/descision_surface/e2_ls2_pred}, \\
      accuracy &= \input{application/data/descision_surface/e2_ls2_acc}
    \end{align*}
    \label{fig:x2_n2}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{align*}
      \tau_{|X|} = 2&, N = 5, \\
      predicted &= \input{application/data/descision_surface/e5_ls2_pred}, \\
      accuracy &= \input{application/data/descision_surface/e5_ls2_acc}
    \end{align*}
    \label{fig:x2_n5}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{align*}
      \tau_{|X|} = 2&, N = 10, \\
      predicted &= \input{application/data/descision_surface/e10_ls2_pred}, \\
      accuracy &= \input{application/data/descision_surface/e10_ls2_acc}
    \end{align*}
    \label{fig:x2_n10}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{align*}
      \tau_{|X|} = 5&, N = 2, \\
      predicted &= \input{application/data/descision_surface/e2_ls5_pred}, \\
      accuracy &= \input{application/data/descision_surface/e2_ls5_acc}
    \end{align*}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    ...
    \begin{align*}
      \tau_{|X|} = 5&, N = 5, \\
      predicted &= \input{application/data/descision_surface/e5_ls5_pred}, \\
      accuracy &= \input{application/data/descision_surface/e5_ls5_acc}
    \end{align*}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    ...
    \begin{align*}
      \tau_{|X|} = 5&, N = 10, \\
      predicted &= \input{application/data/descision_surface/e10_ls5_pred}, \\
      accuracy &= \input{application/data/descision_surface/e10_ls5_acc}
    \end{align*}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{align*}
      \tau_{|X|} = 10&, N = 2, \\
      predicted &= \input{application/data/descision_surface/e2_ls10_pred}, \\
      accuracy &= \input{application/data/descision_surface/e2_ls10_acc}
    \end{align*}
    \label{fig:x10_n2}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{align*}
      \tau_{|X|} = 10&, N = 5, \\
      predicted &= \input{application/data/descision_surface/e5_ls10_pred}, \\
      accuracy &= \input{application/data/descision_surface/e5_ls10_acc}
    \end{align*}
    \label{fig:x10_n5}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{align*}
      \tau_{|X|} = 10&, N = 10, \\
      predicted &= \input{application/data/descision_surface/e10_ls10_pred}, \\
      accuracy &= \input{application/data/descision_surface/e10_ls10_acc}
    \end{align*}
    \label{fig:x10_n10}
  \end{subfigure}
  \end{comment}
